...
class Settings(BaseSettings):
    ...
    min_confidence_price: float = Field(default=0.79, alias='MIN_CONFIDENCE_PRICE')
    max_worst_price: float = Field(default=0.95, alias='MAX_WORST_PRICE')
    ...
    profit_protect_arm_price: float = Field(default=0.90, alias='PROFIT_PROTECT_ARM_PRICE')
    profit_protect_exit_price: float = Field(default=0.87, alias='PROFIT_PROTECT_EXIT_PRICE')
